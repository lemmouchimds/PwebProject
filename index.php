...
<div class="hero-image">
    <div class="hero-text">
      ...
      <a href="Pages/Evenement.html" class="button">Go to events</a>
    </div>
  </div> 
    ...
    <div class="main-content">
        ...
        <div class="left box">
            ...
            <div class="content">
                ...
                <ul class="social">
                        <li><a href="https://www.facebook.com/Micro.Club.USTHB/"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.linkedin.com/in/micro-club-usthb/"><i class="fa fa-linkedin"></i></a></li>
                        <li><a href="https://www.instagram.com/microclub_usthb/"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="https://github.com/MicroClub-USTHB"><i class="fa fa-github"></i></a></li>   
                </ul>
            </div>
        </div>
        ...
        <div class="center box">
            ...
            <div class="content">
                <div class="email">
                    ...
                    <span class="text">Email : <a href="mailto:micro-club@usthb.dz">micro-club@usthb.dz</a> </span>
                </div>
                <div class="phone">
                    <i class="fa fa-phone" style="font-size:24px;color: rgb(255, 255, 255);"></i>
                    <span class="text">President Phone: <a href="tel:+213 558 52 11 45">0558 52 11 45</a> </span>
                </div>
                <div class="fax">
                    <i class="fa fa-fax" style="font-size:24px;color:rgb(255, 255, 255)"></i>
                    <span class="text">External Relationship Phone: <a href="tel:+213542 17 01 14">0542 17 01 14</a></span>
                </div>
                <div class="Location">
                    <i class="fa fa-map-marker" style="font-size:24px;color:rgb(255, 255, 255)"></i>
                    <span class="text">Location : <a href="https://www.google.com/maps?ll=36.720646,3.185523&z=17&t=m&hl=en&gl=GB&mapclient=embed&cid=3141297663324068893">Room 148 Department of informatic in the USTHB</a></span>
                </div>
            </div>
        </div>
        ...
        <div class="right box">
            <h2>Feedback</h2>
            <div class="content">
                <form  action="mails.php">
                    <label for="email">Email</label>
                    <input type="email" name="mail" required placeholder="Your Email">
                    <label for="message">Message</label>
                    <br>
                    <textarea name="text" cols="40" rows="5" placeholder="Your message"></textarea>
